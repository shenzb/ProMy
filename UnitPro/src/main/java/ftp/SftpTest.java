...
/**
 * Created by zhenbiao.shen on 2016/4/15.
 */
public class SftpTest {


        private String host = "192.168.100.112";
        private String username="zhenbiao.shen";
        private String password="shenzb;1!";
        private int port = 22;
        ...
        public static void main(String[] args) {
            ...
            ftp.connect();
//            FTPTest.upload();
            ftp.download("\\技术部\\IT\\Qtalk","qtalkx64.exe","qtalkx64.exe",ftp.getSftp());
            ftp.disconnect();
            System.exit(0);
        }
